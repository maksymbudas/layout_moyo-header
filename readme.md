...
- [DEMO LINK](https://maksymbudas.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://maksymbudas.github.io/layout_moyo-header/report/html_report/)
...
- [x] Pseudo-element is used for a blue line below the git addactive link
